...
<head>
    ...
    <?=\yii\helpers\Html::cssFile('@web/template/style/index.css')?>
    <?=\yii\helpers\Html::cssFile('@web/template/style/bottomnav.css')?>
    <?=\yii\helpers\Html::cssFile('@web/template/style/footer.css')?>
    <!--引入JS文件-->
    <?=\yii\helpers\Html::jsFile('@web/template/js/jquery-1.8.3.min.js')?>
    <?=\yii\helpers\Html::jsFile('@web/template/js/header.js')?>
    <?=\yii\helpers\Html::jsFile('@web/template/js/index.js')?>
</head>
<body>
<!-- 顶部导航 start -->
<div class="topnav">
...
<div class="header w1210 bc mt15">
    ...
    <div class="logo w1210">
        <h1 class="fl"><a href="index.html"><img src="<?=Yii::getAlias('@web')?>/template/images/logo.png" alt="京西商城"></a></h1>
        <!-- 头部搜索 start -->
        <div class="search fl">
            ...
            <dl>
                ...
                <dd>
                    ...
                    <div class="viewlist mt10">
                        <h3>最近浏览的商品：</h3>
                        <ul>
                            <li><a href=""><img src="<?=Yii::getAlias('@web')?>/template/images/view_list1.jpg" alt="" /></a></li>
                            <li><a href=""><img src="<?=Yii::getAlias('@web')?>/template/images/view_list2.jpg" alt="" /></a></li>
                            <li><a href=""><img src="<?=Yii::getAlias('@web')?>/template/images/view_list3.jpg" alt="" /></a></li>
                        </ul>
                    </div>
                </dd>
            </dl>
...
<div class="colligate w1210 bc mt10">
    ...
    <div class="slide fl">
        <div class="area">
            <div class="slide_items">
                <ul>
                    <li><a href=""><img src="<?=Yii::getAlias('@web')?>/template/images/index_slide1.jpg" alt="" /></a></li>
                    <li><a href=""><img src="<?=Yii::getAlias('@web')?>/template/images/index_slide2.jpg" alt="" /></a></li>
                    <li><a href=""><img src="<?=Yii::getAlias('@web')?>/template/images/index_slide3.jpg" alt="" /></a></li>
                    <li><a href=""><img src="<?=Yii::getAlias('@web')?>/template/images/index_slide4.jpg" alt="" /></a></li>
                    <li><a href=""><img src="<?=Yii::getAlias('@web')?>/template/images/index_slide5.jpg" alt="" /></a></li>
                    <li><a href=""><img src="<?=Yii::getAlias('@web')?>/template/images/index_slide6.jpg" alt="" /></a></li>
                </ul>
            </div>
    ...
    <div class="coll_right fl ml10">
        <div class="ad"><a href=""><img src="<?=Yii::getAlias('@web')?>/template/images/ad.jpg" alt="" /></a></div>
        ...
        <div class="service mt10">
            ...
            <div class="service_wrap">
                ...
                <div class="travel none">
                    <ul>
                        <li>
                            <a href=""><img src="<?=Yii::getAlias('@web')?>/template/images/holiday.jpg" alt="" /></a>
                            <a href="" class="button">度假查询</a>
                        </li>
                        <li>
                            <a href=""><img src="<?=Yii::getAlias('@web')?>/template/images/scenic.jpg" alt="" /></a>
                ...
                <div class="lottery none">
                    <p><img src="<?=Yii::getAlias('@web')?>/template/images/lottery.jpg" alt="" /></p>
                </div>
                <!-- 彩票 end -->
                ...
                <div class="game none">
                    <ul>
                        <li><a href=""><img src="<?=Yii::getAlias('@web')?>/template/images/sanguo.jpg" alt="" /></a></li>
                        <li><a href=""><img src="<?=Yii::getAlias('@web')?>/template/images/taohua.jpg" alt="" /></a></li>
                        <li><a href=""><img src="<?=Yii::getAlias('@web')?>/template/images/wulin.jpg" alt="" /></a></li>
                    </ul>
                </div>
                <!-- 游戏 end -->
            </div>
...
<div class="guide w1210 bc mt15">
        ...
        <div class="guide_wrap">
            ...
            <div class="crazy">
                <ul>
                    <li>
                        <dl>
                            <dt><a href=""><img src="<?=Yii::getAlias('@web')?>/template/images/crazy1.jpg" alt="" /></a></dt>
                    ...
                    <li>
                        <dl>
                            <dt><a href=""><img src="<?=Yii::getAlias('@web')?>/template/images/crazy2.jpg" alt="" /></a></dt>
                    ...
                    <li>
                        <dl>
                            <dt><a href=""><img src="<?=Yii::getAlias('@web')?>/template/images/crazy3.jpg" alt="" /></a></dt>
                    ...
                    <li>
                        <dl>
                            <dt><a href=""><img src="<?=Yii::getAlias('@web')?>/template/images/crazy4.jpg" alt="" /></a></dt>
                    ...
                    <li>
                        <dl>
                            <dt><a href=""><img src="<?=Yii::getAlias('@web')?>/template/images/crazy5.jpg" alt="" /></a></dt>
            ...
            <div class="hot none">
                <ul>
                    <li>
                        <dl>
                            <dt><a href=""><img src="<?=Yii::getAlias('@web')?>/template/images/hot1.jpg" alt="" /></a></dt>
                    ...
                    <li>
                        <dl>
                            <dt><a href=""><img src="<?=Yii::getAlias('@web')?>/template/images/hot2.jpg" alt="" /></a></dt>
                    ...
                    <li>
                        <dl>
                            <dt><a href=""><img src="<?=Yii::getAlias('@web')?>/template/images/hot3.jpg" alt="" /></a></dt>
            ...
            <div class="recommend none">
                <ul>
                    <li>
                        <dl>
                            <dt><a href=""><img src="<?=Yii::getAlias('@web')?>/template/images/recommend1.jpg" alt="" /></a></dt>
                    ...
                    <li>
                        <dl>
                            <dt><a href=""><img src="<?=Yii::getAlias('@web')?>/template/images/recommend2.jpg" alt="" /></a></dt>
                    ...
                    <li>
                        <dl>
                            <dt><a href=""><img src="<?=Yii::getAlias('@web')?>/template/images/recommend3.jpg" alt="" /></a></dt>
    ...
    <div class="sidebar fl ml10">
        ...
        <div class="sidebar_wrap">
            <dl class="first">
                <dt class="fl"><a href=""><img src="<?=Yii::getAlias('@web')?>/template/images/viewsonic.jpg" alt="" /></a></dt>
            ...
            <dl>
                <dt class="fr"><a href=""><img src="<?=Yii::getAlias('@web')?>/template/images/samsung.jpg" alt="" /></a></dt>
...
<div class="floor1 floor w1210 bc mt10">
    ...
    <div class="floor_left fl">
        ...
        <div class="cate fl">
            ...
            <div class="cate_wrap">
                ...
                <p><a href=""><img src="<?=Yii::getAlias('@web')?>/template/images/notebook.jpg" alt="" /></a></p>
            </div>
            ...
            <div class="goodslist_wrap">
                <div>
                    <ul>
                        <li>
                            <dl>
                                <dt><a href=""><img src="<?=Yii::getAlias('@web')?>/template/images/hpG4.jpg" alt="" /></a></dt>
                        ...
                        <li>
                            <dl>
                                <dt><a href=""><img src="<?=Yii::getAlias('@web')?>/template/images/thinkpad e420.jpg" alt="" /></a></dt>
                        ...
                        <li>
                            <dl>
                                <dt><a href=""><img src="<?=Yii::getAlias('@web')?>/template/images/acer4739.jpg" alt="" /></a></dt>
                        ...
                        <li>
                            <dl>
                                <dt><a href=""><img src="<?=Yii::getAlias('@web')?>/template/images/samsung6800.jpg" alt="" /></a></dt>
                        ...
                        <li>
                            <dl>
                                <dt><a href=""><img src="<?=Yii::getAlias('@web')?>/template/images/lh531.jpg" alt="" /></a></dt>
                        ...
                        <li>
                            <dl>
                                <dt><a href=""><img src="<?=Yii::getAlias('@web')?>/template/images/qinghuax2.jpg" alt="" /></a></dt>
    ...
    <div class="sidebar fl ml10">
        ...
        <div class="brand">
            ...
            <div class="sidebar_wrap">
                <ul>
                    <li><a href=""><img src="<?=Yii::getAlias('@web')?>/template/images/dell.gif" alt="" /></a></li>
                    <li><a href=""><img src="<?=Yii::getAlias('@web')?>/template/images/acer.gif" alt="" /></a></li>
                    <li><a href=""><img src="<?=Yii::getAlias('@web')?>/template/images/fujitsu.jpg" alt="" /></a></li>
                    <li><a href=""><img src="<?=Yii::getAlias('@web')?>/template/images/hp.jpg" alt="" /></a></li>
                    <li><a href=""><img src="<?=Yii::getAlias('@web')?>/template/images/lenove.jpg" alt="" /></a></li>
                    <li><a href=""><img src="<?=Yii::getAlias('@web')?>/template/images/samsung.gif" alt="" /></a></li>
                    <li><a href=""><img src="<?=Yii::getAlias('@web')?>/template/images/dlink.gif" alt="" /></a></li>
                    <li><a href=""><img src="<?=Yii::getAlias('@web')?>/template/images/seagate.jpg" alt="" /></a></li>
                    <li><a href=""><img src="<?=Yii::getAlias('@web')?>/template/images/intel.jpg" alt="" /></a></li>
                </ul>
            </div>
        </div>
        <!-- 品牌旗舰店 end -->
        ...
        <!-- 广告 start -->
        <div class="ads mt10">
            <a href=""><img src="<?=Yii::getAlias('@web')?>/template/images/canon.jpg" alt="" /></a>
        </div>
        <!-- 广告 end -->
    </div>
    <!-- 右侧 end -->
