...
<head>
    ...
    <?=\yii\helpers\Html::cssFile('@web/template/style/list.css')?>
    <?=\yii\helpers\Html::cssFile('@web/template/style/common.css')?>
    <?=\yii\helpers\Html::cssFile('@web/template/style/goods.css')?>
    <!--引入JS文件-->
    <?=\yii\helpers\Html::jsFile('@web/template/js/jquery-1.8.3.min.js')?>
    <?=\yii\helpers\Html::jsFile('@web/template/js/header.js')?>
    <?=\yii\helpers\Html::jsFile('@web/template/js/list.js')?>
    <?=\yii\helpers\Html::jsFile('@web/template/js/goods.js')?>
    <?=\yii\helpers\Html::jsFile('@web/template/js/jqzoom-core.js')?>

	<!--引入jqzoom css -->
    <?=\yii\helpers\Html::cssFile('@web/template/style/jqzoom.css')?>
			...
			<div class="related_view newgoods leftbar mt10">
				...
				<div class="leftbar_wrap">
					<ul>
						<li>
							<dl>
								<dt><a href=""><img src="<?=Yii::getAlias('@web')?>/template/images/relate_view1.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="<?=Yii::getAlias('@web')?>/template/images/relate_view2.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="<?=Yii::getAlias('@web')?>/template/images/relate_view3.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="<?=Yii::getAlias('@web')?>/template/images/relate_view4.jpg" alt="" /></a></dt>
						...
						<li class="last">
							<dl>
								<dt><a href=""><img src="<?=Yii::getAlias('@web')?>/template/images/relate_view5.jpg" alt="" /></a></dt>
				...
				<div class="preview fl">
					...
					<div class="smallpic">
						...
						<div class="smallpic_wrap">
							<ul>
								<li class="cur">
									<a class="zoomThumbActive" href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: 'images/preview_m1.jpg',largeimage: 'images/preview_l1.jpg'}"><img src="<?=Yii::getAlias('@web')?>/template/images/preview_s1.jpg"></a>
								</li>
								<li>
									<a href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: 'images/preview_m2.jpg',largeimage: 'images/preview_l2.jpg'}"><img src="<?=Yii::getAlias('@web')?>/template/images/preview_s2.jpg"></a>
								</li>
								<li>
									<a href="javascript:void(0);" 
									rel="{gallery: 'gal1', smallimage: 'images/preview_m3.jpg',largeimage: 'images/preview_l3.jpg'}">  
	    							<img src="<?=Yii::getAlias('@web')?>/template/images/preview_s3.jpg"></a>
								</li>
								<li>
									<a href="javascript:void(0);" 
									rel="{gallery: 'gal1', smallimage: 'images/preview_m4.jpg',largeimage: 'images/preview_l4.jpg'}">  
	    							<img src="<?=Yii::getAlias('@web')?>/template/images/preview_s4.jpg"></a>
								</li>
								<li>
									<a href="javascript:void(0);" 
									rel="{gallery: 'gal1', smallimage: 'images/preview_m5.jpg',largeimage: 'images/preview_l5.jpg'}">  
	    							<img src="<?=Yii::getAlias('@web')?>/template/images/preview_s5.jpg"></a>
								</li>
								<li>
									<a href="javascript:void(0);" 
									rel="{gallery: 'gal1', smallimage: 'images/preview_m6.jpg',largeimage: 'images/preview_l6.jpg'}">  
	    							<img src="<?=Yii::getAlias('@web')?>/template/images/preview_s6.jpg"></a>
								</li>
								<li>
									<a href="javascript:void(0);" 
									rel="{gallery: 'gal1', smallimage: 'images/preview_m7.jpg',largeimage: 'images/preview_l7.jpg'}">  
	    							<img src="<?=Yii::getAlias('@web')?>/template/images/preview_s7.jpg"></a>
								</li>
								<li>
									<a href="javascript:void(0);" 
									rel="{gallery: 'gal1', smallimage: 'images/preview_m8.jpg',largeimage: 'images/preview_l8.jpg'}">  
	    							<img src="<?=Yii::getAlias('@web')?>/template/images/preview_s8.jpg"></a>
								</li>
								<li>
									<a href="javascript:void(0);" 
									rel="{gallery: 'gal1', smallimage: 'images/preview_m9.jpg',largeimage: 'images/preview_l9.jpg'}">  
	    							<img src="<?=Yii::getAlias('@web')?>/template/images/preview_s9.jpg"></a>
								</li>
							</ul>
						</div>
				...
				<div class="detail_bd">
					...
					<div class="introduce detail_div none">
						...
						<div class="desc mt10">
							...
							<img src="<?=Yii::getAlias('@web')?>/template/images/desc1.jpg" alt="" />
							<p style="height:10px;"></p>
                            <b><?= $goods_intro->content?></b>
                            </div>
						</div>
					</div>
					<!-- 商品介绍 end -->
					...
					<div class="comment detail_div mt10">
						...
						<div class="comment_items mt10">
							<div class="user_pic">
								<dl>
									<dt><a href=""><img src="<?=Yii::getAlias('@web')?>/template/images/user1.gif" alt="" /></a></dt>
									<dd><a href="">乖乖</a></dd>
								</dl>
							</div>
							<div class="item">
						...
						<div class="comment_items mt10">
							<div class="user_pic">
								<dl>
									<dt><a href=""><img src="<?=Yii::getAlias('@web')?>/template/images/user2.jpg" alt="" /></a></dt>
									<dd><a href="">小宝贝</a></dd>
								</dl>
							</div>
							<div class="item">
						...
						<div class="comment_items mt10">
							<div class="user_pic">
								<dl>
									<dt><a href=""><img src="<?=Yii::getAlias('@web')?>/template/images/user3.jpg" alt="" /></a></dt>
									<dd><a href="">天使</a></dd>
								</dl>
							</div>
							<div class="item">
