		...
		<div class="list_bd fl ml10 mt10">
			...
			<div class="goodslist mt10">
				<ul>
					...
					<li><?php //var_dump(Yii::getAlias('@backend').'/web'.$model->logo);exit;?>
						<dl>
							<dt><a href="<?=\yii\helpers\Url::to(["goods/details?id=$model->id"])?>"><img src="<?=Yii::getAlias('@backend').'/web'.$model->logo?>" alt="" /></a></dt>
