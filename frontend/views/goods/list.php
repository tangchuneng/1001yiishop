		...
		<div class="topnav_bd w1210 bc">
			...
			<div class="topnav_right fr">
				<ul>
					...
					<li class="line">|</li>
					<li><a href="<?=\yii\helpers\Url::to(["order/index"])?>">我的订单</li>
					<li class="line">|</li>
					<li>客户服务</li>
			...
			<div class="newgoods leftbar mt10">
				...
				<div class="leftbar_wrap">
					<ul>
						<li>
							<dl>
								<dt><a href=""><img src="<?=Yii::getAlias('@web')?>/template/images/list_hot1.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="<?=Yii::getAlias('@web')?>/template/images/list_hot2.jpg" alt="" /></a></dt>
						...
						<li class="last">
							<dl>
								<dt><a href=""><img src="<?=Yii::getAlias('@web')?>/template/images/list_hot3.jpg" alt="" /></a></dt>
		...
		<div class="list_bd fl ml10 mt10">
			...
			<div class="goodslist mt10">
				<ul>
					...
					<li>
						<dl>
                            <dt><a href="<?=\yii\helpers\Url::to(["goods/details?id=$model->id"])?>"><img src="<?='http://admin.yiishop.com'.$model->logo?>" height="50px" alt="logo加载失败" /></a></dt>
							<dd><a href="<?=\yii\helpers\Url::to(["goods/details?id=$model->id"])?>"><?=$model->name?></a></dt>
